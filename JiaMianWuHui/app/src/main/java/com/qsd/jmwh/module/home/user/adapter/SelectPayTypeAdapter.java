...
public class SelectPayTypeAdapter extends BaseQuickAdapter<PayTypeBean, BaseViewHolder> {

    public SelectPayTypeAdapter(int layoutResId, @Nullable List<PayTypeBean> data) {
