...
public interface ApiServices {
  ...
  }, Url = "/UserService/registUser") Observable<LoginInfo> register(String sAuthCode,
  ...
  @NetMethod(ParameterNames = {
      "lUserId", "nLat", "nLng", "sDatingRange", "nTab", "pageindex"
  }, Url = "/DatingService/getDatingList") Observable<HomeRadioListBean> getRadioDateAll(
      String lUserId, double nLat, double nLng, String sDatingRange, String nTab, String pageindex);
  ...
  }, Url = "/UserService/userAuthByCode") Observable<CommitCodeResultBean> getUserAuthByCode(
      int lUserId, String token, String code);
  ...
  @NetMethod(ParameterNames = {
      "sMobile", "sPwd", "sAuthCode"
  }, Url = "/UserService/bindMobile") Observable<Object> bindPhone(String sMobile, String sPwd,
      String sAuthCode);
  ...
  @NetMethod(ParameterNames = {
      "lDatingId", "lJoinerId", "lInitiatorId"
  }, Url = "/DatingService/addDatingLikeCount") Observable<Object> addDatingLikeCount(
      String lDatingId, String lJoinerId, String lInitiatorId);

  @NetMethod(Url = "/DatingService/getDatingUserVIP")
  Observable<GetDatingUserVipBean> getDatingUserVIP();

  @NetMethod(ParameterNames = {
      "lDatingId", "lJoinerId", "lInitiatorId", "sContent"
  }, Url = "/DatingService/addDatingCommentCount") Observable<Object> addDatingCommentCount(
      String lDatingId, String lJoinerId, String lInitiatorId, String sContent);

  @NetMethod(ParameterNames = {
      "lDatingId", "lJoinerId", "lInitiatorId", "sContent"
  }, Url = "/DatingService/addDatingEnroll") Observable<Object> addDatingEnroll(String lDatingId,
      String lJoinerId, String lInitiatorId, String sContent);

  @NetMethod(ParameterNames = {
      "sDatingTitle", "sDatingRange", "sDatingTime", "sDatingTimeExt", "sContent", "nSex", "nLng",
      "nLat", "bCommentType", "bHiddenType", "sImg", "sDatingHope"
  }, Url = "/DatingService/addDating") Observable<Object> addDating(String sDatingTitle,
      String sDatingRange, String sDatingTime, String sDatingTimeExt, String sContent, String nSex,
      double nLng, double nLat, String bCommentType, String bHiddenType, String sImg,
      String sDatingHope);
  ...
  @NetMethod(Url = "/MaskBallService/getBannerList") Observable<HomeBannerBean> getBannerList();
}
