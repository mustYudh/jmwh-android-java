package com.qsd.jmwh.module.im.receiver;
...
import com.qsd.jmwh.module.im.help.CustomNotificationCache;
...
public class CustomNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(intent.getAction())) {
            ...
            // 从intent中取出自定义通知
            CustomNotification
                notification = (CustomNotification) intent.getSerializableExtra(NimIntent.EXTRA_BROADCAST_MSG);
            try {
                ...
                if (obj != null && obj.getIntValue("id") == 2) {
                    ...
                    String
                        tip = String.format("自定义消息[%s]：%s", notification.getFromAccount(), content);
