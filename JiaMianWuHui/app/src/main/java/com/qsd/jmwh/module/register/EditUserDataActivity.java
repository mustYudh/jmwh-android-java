...
public class EditUserDataActivity extends BaseBarActivity implements EditUserInfoViewer, View.OnClickListener {
    @PresenterLifeCycle
    ...
    public void setUserHeaderSuccess(String url) {
        ...
        ImageLoader.loadCenterCrop(EditUserDataActivity.this, url,
                selectHeader, R.mipmap.ic_launcher);
    }
