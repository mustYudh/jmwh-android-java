...
public class MineRadioListActivity extends BaseBarActivity implements MineRadioViewer {
  ...
  @PresenterLifeCycle private MineRadioPresenter mPresenter = new MineRadioPresenter(this);
  ...
  @Override public void getMineRadioList(MineRadioListBean mineRadioListBean) {
    if (mineRadioListBean != null) {
      if (mineRadioListBean.cdoList != null && mineRadioListBean.cdoList.size() != 0) {
        ...
        adapter.setOnPersonItemClickListener(new MineRadioRvAdapter.OnRadioItemClickListener() {
          ...
          @Override public void setOnPersonInfoItemClick(int lLoveUserId) {
            getLaunchHelper().startActivity(
                LookUserInfoActivity.getIntent(getActivity(), lLoveUserId, lLoveUserId, 2));
          }

          @Override public void setOnAddContentItemClick(LocalHomeRadioListBean item) {
            ToastUtils.show("你不能评论自己");
          }

          @Override public void setOnAddDatingEnrollItemClick(LocalHomeRadioListBean item) {
          ...
          @Override public void setOnCloseEnrollItemClick(LocalHomeRadioListBean item) {
  ...
  @Override public void getModifyStatus(LocalHomeRadioListBean item) {
    ToastUtils.show("取消成功");
    item.nStatus = 1;
    adapter.notifyDataSetChanged();
  }

  @Override public void getConfigDataSuccess(GetRadioConfigListBean configListBean) {
